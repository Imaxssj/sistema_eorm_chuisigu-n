...
$name_encargado = isset($_POST["nombre_encargado"]) ? limpiarCadena($_POST["nombre_encargado"]) : "";
$lastname_encargado = isset($_POST["apellidos_encargado"]) ? limpiarCadena($_POST["apellidos_encargado"]) : "";
$dpi_encargado = isset($_POST["dpi_encargado"]) ? limpiarCadena($_POST["dpi_encargado"]) : "";
...
switch ($_GET["op"]) {
	case 'guardaryeditar':
		...
		if (empty($id)) {
			$rspta = $alumnos->insertar($image, $name, $lastname, $email, $address, $phone, $c1_fullname, $c1_address, $c1_phone, $c1_note, $user_id, $team_id, $name_encargado, $lastname_encargado, $dpi_encargado);
			echo $rspta ? "Datos registrados correctamente" : "No se pudo registrar los datos";
		} else {
			$rspta = $alumnos->editar($id, $image, $name, $lastname, $email, $address, $phone, $c1_fullname, $c1_address, $c1_phone, $c1_note, $user_id, $team_id, $name_encargado, $lastname_encargado, $dpi_encargado);
