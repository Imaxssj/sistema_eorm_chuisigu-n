            ...
            <div class="box">
              <div class="box-header with-border">
                ...
                if ($idusuario === '1' || $idusuario === '2')
                  echo '<h1 class="box-title">Grupo: <?php echo $nombre_grupo; ?> <button class="btn btn-success" onclick="mostrarform(true)" id="btnagregar"><i class="fa fa-plus-circle"></i>Agregar Alumno</button> </h1>';
                ?>
                <a id="btnasistencia" href="asistencia.php?idgrupo=<?php echo $idgrupo; ?>" class="btn btn-warning"><i class='fa fa-check'></i> Asistencia</a>
                <a id="btnconducta" href="conducta.php?idgrupo=<?php echo $idgrupo; ?>" class="btn btn-primary"><i class="fa fa-face-grin-wide"></i> Comportamiento</a>
                ...
                <a id="btncalificaciones" href="alimentacion.php?idgrupo=<?php echo $idgrupo; ?>" class="btn btn-success"><i class="fa fa-carrot"></i> Alimentación</a>
                <a id="btncalificaciones" href="utiles.php?idgrupo=<?php echo $idgrupo; ?>" class="btn btn-warning"><i class="fa fa-pen-ruler"></i> Útiles</a>
              ...
              <div class="panel-body" id="formularioregistros">
                <form action="" name="formulario" id="formulario" method="POST">
                  ...
                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <hr>
                    <h4>Sección de Encargado</h4>
                  </div>
                  <div class="form-group col-lg-6 col-md-6 col-xs-12">
                    <label for="">Nombres(*):</label>
                    <input class="form-control" type="text" name="nombre_encargado" id="nombre_encargado" maxlength="100" placeholder="Nombre" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" required>
                  </div>
                  <div class="form-group col-lg-6 col-md-6 col-xs-12">
                    <label for="">Apellidos(*):</label>
                    <input class="form-control" type="text" name="apellidos_encargado" id="apellidos_encargado" maxlength="100" placeholder="Nombre" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" required>
                  </div>
                  <div class="form-group col-lg-6 col-md-6 col-xs-12">
                    <label for="">DPI(*):</label>
                    <input class="form-control" type="text" name="dpi_encargado" id="dpi_encargado" maxlength="13" minlength="13" placeholder="Nombre" onKeyUp="document.getElementById(this.id).value=document.getElementById(this.id).value.toUpperCase()" required>
                  </div>
                  <div class="form-group col-lg-6 col-md-6 col-xs-12">
                    <label for="">Teléfono(*)</label>
                    <input class="form-control" type="text" minlength="8" maxlength="8" name="telefono" id="telefono" placeholder="Dirección" required>
                  </div>
                  <div class="form-group col-lg-12 col-md-12 col-sm-12 col-xs-12">
